function calculate() {
  ...
  function calculate1(){
    ...
    if (elecNumber <= 10) {
      ...
      bac1.innerHTML = "Điện bậc 1: " + cost.toLocaleString('vi-VN') + " VNĐ";
      ...
      bac1.innerHTML = "Điện bậc 1: " + dienBac1.toLocaleString('vi-VN') + " VNĐ";
      bac2.innerHTML = "Điện bậc 2: " + ((elecNumber - 10) * 1866).toLocaleString('vi-VN') + " VNĐ";
      bac3.innerHTML = "Điện bậc 3: " + 0;
      bac4.innerHTML = "Điện bậc 4: " + 0;
      bac5.innerHTML = "Điện bậc 5: " + 0;
      bac6.innerHTML = "Điện bậc 6: " + 0;
      ...
      bac1.innerHTML = "Điện bậc 1: " +dienBac1.toLocaleString('vi-VN') + " VNĐ";
      bac2.innerHTML = "Điện bậc 2: " + dienBac2.toLocaleString('vi-VN') + " VNĐ";
      bac3.innerHTML = "Điện bậc 3: " + ((elecNumber - 20) * 2167).toLocaleString('vi-VN') + " VNĐ";
      bac4.innerHTML = "Điện bậc 4: " + 0;
      bac5.innerHTML = "Điện bậc 5: " + 0;
      bac6.innerHTML = "Điện bậc 6: " + 0;
      ...
      bac1.innerHTML = "Điện bậc 1: " +dienBac1.toLocaleString('vi-VN') + " VNĐ";
      bac2.innerHTML = "Điện bậc 2: " + dienBac2.toLocaleString('vi-VN') + " VNĐ";
      bac3.innerHTML = "Điện bậc 3: " + dienBac3.toLocaleString('vi-VN') + " VNĐ";
      bac4.innerHTML = "Điện bậc 4: " + ((elecNumber - 41) * 2729).toLocaleString('vi-VN') + " VNĐ";
      bac5.innerHTML = "Điện bậc 5: " + 0;
      bac6.innerHTML = "Điện bậc 6: " + 0;
      ...
      bac2.innerHTML = "Điện bậc 2: " + dienBac2.toLocaleString('vi-VN') + " VNĐ";
      bac3.innerHTML = "Điện bậc 3: " + dienBac3.toLocaleString('vi-VN') + " VNĐ";
      bac4.innerHTML = "Điện bậc 4: " + dienBac4.toLocaleString('vi-VN') + " VNĐ";
      bac5.innerHTML = "Điện bậc 5: " + ((elecNumber - 62) * 3050).toLocaleString('vi-VN') + " VNĐ";
      bac6.innerHTML = "Điện bậc 6: " + 0;
  } else {
      ...
      bac3.innerHTML = "Điện bậc 3: " + dienBac3.toLocaleString('vi-VN') + " VNĐ";
      bac4.innerHTML = "Điện bậc 4: " + dienBac4.toLocaleString('vi-VN') + " VNĐ";
      bac5.innerHTML = "Điện bậc 5: " + dienBac5.toLocaleString('vi-VN') + " VNĐ";
      bac6.innerHTML = "Điện bậc 6: " + ((elecNumber - 83) * 3151).toLocaleString('vi-VN') + " VNĐ";
  ...
  document.getElementById('totalCost').innerHTML ="Tổng tiền: " + tongtien.toLocaleString('vi-VN') + " VNĐ";
